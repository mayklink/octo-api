...
import { ConfigureAzureCredentialDto, CreateRepositoryDto, DiscoverAzureRepositoriesDto, UpdateRepositoryDto } from "./repositories.dto";
...
export class RepositoriesController {
  ...
  @Post("discover") @Roles("owner", "admin") discover(@Body() dto: DiscoverAzureRepositoriesDto) { return this.repositories.discoverAzureRepositories(dto); }
